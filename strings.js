...
export const ui = {
  en: {
    ...
    description: (nv, ns) => `German prefix verbs as a one-armed bandit: ${nv} verbs from ${ns} stems, each with Präsens, Präteritum, Perfekt, its rection and an example sentence. Free, no sign-up.`,
    ...
    indexTitle: (nv) => `All ${nv} German prefix verbs, by stem · tja`,
    ...
    indexIntro: (nv, ns) => `Every verb in the collection: ${nv} of them, built from ${ns} stems. Each one gives the meaning, says whether the prefix separates, and shows the Präsens, Präteritum and Perfekt. Pick one to open it in the machine.`,
    allVerbs: "all verbs",
  ...
  ru: {
    ...
    description: (nv, ns) => `Немецкие глаголы с приставками как однорукий бандит: ${nv} ${plural(nv,"глагол","глагола","глаголов")} из ${ns} ${plural(ns,"корня","корней","корней")}, у каждого Präsens, Präteritum, Perfekt, управление и пример. Бесплатно, без регистрации.`,
    ...
    indexTitle: (nv) => `Все ${nv} немецких ${plural(nv,"глагол","глагола","глаголов")} с приставками · tja`,
    ...
    indexIntro: (nv, ns) => `Все глаголы: ${nv} ${plural(nv,"штука","штуки","штук")} из ${ns} ${plural(ns,"корня","корней","корней")}. У каждого есть значение, пометка об отделяемости приставки и формы Präsens, Präteritum и Perfekt. Нажмите на любой, чтобы открыть его в автомате.`,
  ...
  fr: {
    ...
    description: (nv, ns) => `Les verbes à particule allemands comme un bandit manchot : ${nv} verbe${nv > 1 ? "s" : ""} issus de ${ns} radica${ns > 1 ? "ux" : "l"}, chacun avec Präsens, Präteritum, Perfekt, sa rection et une phrase d'exemple. Gratuit, sans inscription.`,
    ...
    indexTitle: (nv) => `Les ${nv} verbes à particule allemands, par radical · tja`,
    ...
    indexIntro: (nv, ns) => `Tous les verbes de la collection : ${nv}, formés sur ${ns} radica${ns > 1 ? "ux" : "l"}. Chaque entrée donne le sens, indique si la particule se sépare et montre le Präsens, le Präteritum et le Perfekt. Cliquez sur un verbe pour l'ouvrir dans la machine.`,
